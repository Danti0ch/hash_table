# hash_table
Реализация, оптимизация и анализ хэш таблицы с закрытой адресацией. Значения хэш таблицы - значения int. Ключи - строки. Ключи хранятся в буфере в ячейках по 32 байта. Или если длина ключа превышает 32, то под каждый ключ выделяется память. ХОсновные функции: создания таблицы, удаления таблицы, вставки ключа в таблице и проверку нахождения ключа в таблице. Хэш функция - crc32.
